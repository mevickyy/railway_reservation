...
(function ($, undefined) {
    $.fn.czMore = function (options) {
        ...
        return this.each(function () {
            ...
            var count = '<input id="' + this.id + '_czMore_txtCount" name="' + this.id + '_czMore_txtCount" type="hidden" value="0" size="50" />';
            ...
            btnPlus.addClass('margin-top-20');
            ...
            function loadMinus(recordset) {
                ...
                btnMinus.addClass('margin-top-20');
            }
